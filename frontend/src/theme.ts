...
export const theme = createTheme({
  ...
  components: {
    MuiButton: {
      styleOverrides: {
        root: {
          ...
          transition: 'none',
          fontSize: '0.55rem',
          '&:active': { boxShadow: '1px 1px 0 #000', transform: 'translate(3px,3px)' },
    ...
    MuiChip:  { styleOverrides: { root: { borderRadius: 0, fontSize: '0.6rem' } } },
    MuiAlert: { styleOverrides: { root: { borderRadius: 0, fontSize: '0.6rem' } } },
    MuiTextField: {
      styleOverrides: {
        root: {
          '& .MuiOutlinedInput-root': { borderRadius: 0 },
          '& input': { fontSize: '0.6rem', fontFamily: '"Press Start 2P", monospace' },
          '& label': { fontSize: '0.6rem', fontFamily: '"Press Start 2P", monospace' },
        },
      },
    },
